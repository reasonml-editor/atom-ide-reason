    ...
    debounce: {
        ...
        properties: {
            linter: {
                type: 'integer',
                title: 'Linter',
                description: 'How long to idle (in milliseconds) after keypresses ' +
    ...
    diagnostics: {
        ...
        properties: {
            tools: {
                ...
                description: 'Specifies which tool or tools will be used ' +
    ...
    path: {
        ...
        properties: {
            ...
            env: {
                type: 'string',
                title: 'env',
                description: 'The path to the `env` command which prints ' +
